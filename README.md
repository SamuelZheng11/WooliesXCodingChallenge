...
Under normal development envrionment I would **NEVER** push directly onto master, instead creating PRs for each feature change I made (thats why you see the [JOB_NUMBER] tag on each of the feature commits).
